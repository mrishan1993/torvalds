...
var OwnershipControllerApi = /** @class */ (function (_super) {
     ...
     */
    OwnershipControllerApi.prototype.getAllOwnershipsRaw = function (requestParameters) {
     ...
     * Returns all ownerships
     */
    OwnershipControllerApi.prototype.getAllOwnerships = function (requestParameters) {
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.getAllOwnershipsRaw(requestParameters)];
                    case 1:
                        response = _a.sent();
