...
exports.NftCollectionControllerApi = void 0;
var runtime = __importStar(require("../runtime"));
/**
 * no description
 */
var NftCollectionControllerApi = /** @class */ (function (_super) {
    __extends(NftCollectionControllerApi, _super);
    function NftCollectionControllerApi() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    /**
     * Returns next available tokenId for minter
     */
    NftCollectionControllerApi.prototype.generateNftTokenIdRaw = function (requestParameters) {
                ...
                switch (_d.label) {
                    case 0:
                        if (requestParameters.collection === null || requestParameters.collection === undefined) {
                            throw new runtime.RequiredError('collection', 'Required parameter requestParameters.collection was null or undefined when calling generateNftTokenId.');
                        }
                        if (requestParameters.minter === null || requestParameters.minter === undefined) {
                            throw new runtime.RequiredError('minter', 'Required parameter requestParameters.minter was null or undefined when calling generateNftTokenId.');
                        }
                        queryParameters = {};
                        ...
                        return [4 /*yield*/, this.request({
                                path: "/v0.1/nft/collections/{collection}/generate_token_id".replace("{" + "collection" + "}", encodeURIComponent(String(requestParameters.collection))),
                                method: 'GET',
     ...
     * Returns next available tokenId for minter
     */
    NftCollectionControllerApi.prototype.generateNftTokenId = function (requestParameters) {
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.generateNftTokenIdRaw(requestParameters)];
                    case 1:
                        response = _a.sent();
     ...
     */
    NftCollectionControllerApi.prototype.getNftCollectionByIdRaw = function (requestParameters) {
        return __awaiter(this, void 0, void 0, function () {
            var queryParameters, headerParameters, response;
            var _a, _b, _c, _d;
            return __generator(this, function (_e) {
                switch (_e.label) {
                    case 0:
                        ...
                        headerParameters = {};
                        return [4 /*yield*/, this.request({
                                path: "/v0.1/nft/collections/{collection}".replace("{" + "collection" + "}", encodeURIComponent(String(requestParameters.collection))),
                                method: 'GET',
                                headers: headerParameters,
                                query: queryParameters,
                            })];
     ...
     * Returns collection by address
     */
    NftCollectionControllerApi.prototype.getNftCollectionById = function (requestParameters) {
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
     ...
     */
    NftCollectionControllerApi.prototype.searchNftAllCollectionsRaw = function (requestParameters) {
        return __awaiter(this, void 0, void 0, function () {
            var queryParameters, headerParameters, response;
            var _a, _b, _c;
            return __generator(this, function (_d) {
     ...
     * Returns all NFT collections
     */
    NftCollectionControllerApi.prototype.searchNftAllCollections = function (requestParameters) {
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
     ...
     */
    NftCollectionControllerApi.prototype.searchNftCollectionsByOwnerRaw = function (requestParameters) {
        return __awaiter(this, void 0, void 0, function () {
            var queryParameters, headerParameters, response;
            var _a, _b, _c;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        headerParameters = {};
                        return [4 /*yield*/, this.request({
                                path: "/v0.1/nft/collections/byOwner",
                                method: 'GET',
                                headers: headerParameters,
                                query: queryParameters,
                            })];
     ...
     * Returns collection by owner
     */
    NftCollectionControllerApi.prototype.searchNftCollectionsByOwner = function (requestParameters) {
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    return NftCollectionControllerApi;
}(runtime.BaseAPI));
exports.NftCollectionControllerApi = NftCollectionControllerApi;
