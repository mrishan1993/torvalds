...
exports.NftOwnershipControllerApi = void 0;
var runtime = __importStar(require("../runtime"));
/**
 * no description
 */
var NftOwnershipControllerApi = /** @class */ (function (_super) {
    __extends(NftOwnershipControllerApi, _super);
    function NftOwnershipControllerApi() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    /**
     */
    NftOwnershipControllerApi.prototype.getNftAllOwnershipsRaw = function (requestParameters) {
    ...
    /**
     */
    NftOwnershipControllerApi.prototype.getNftAllOwnerships = function (requestParameters) {
        return __awaiter(this, void 0, void 0, function () {
            var response;
    ...
    /**
     */
    NftOwnershipControllerApi.prototype.getNftOwnershipByIdRaw = function (requestParameters) {
        return __awaiter(this, void 0, void 0, function () {
            var queryParameters, headerParameters, response;
            var _a, _b, _c, _d;
            return __generator(this, function (_e) {
                switch (_e.label) {
                    case 0:
                        ...
                        headerParameters = {};
                        return [4 /*yield*/, this.request({
                                path: "/v0.1/nft/ownerships/{ownershipId}".replace("{" + "ownershipId" + "}", encodeURIComponent(String(requestParameters.ownershipId))),
                                method: 'GET',
                                headers: headerParameters,
                                query: queryParameters,
                            })];
    ...
    /**
     */
    NftOwnershipControllerApi.prototype.getNftOwnershipById = function (requestParameters) {
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    /**
     */
    NftOwnershipControllerApi.prototype.getNftOwnershipsByItemRaw = function (requestParameters) {
        return __awaiter(this, void 0, void 0, function () {
            var queryParameters, headerParameters, response;
            var _a, _b, _c;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        headerParameters = {};
                        return [4 /*yield*/, this.request({
                                path: "/v0.1/nft/ownerships/byItem",
                                method: 'GET',
                                headers: headerParameters,
                                query: queryParameters,
                            })];
    ...
    /**
     */
    NftOwnershipControllerApi.prototype.getNftOwnershipsByItem = function (requestParameters) {
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
