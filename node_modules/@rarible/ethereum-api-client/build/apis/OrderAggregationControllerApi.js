...
var OrderAggregationControllerApi = /** @class */ (function (_super) {
    __extends(OrderAggregationControllerApi, _super);
     ...
     */
    OrderAggregationControllerApi.prototype.aggregateNftPurchaseByCollectionRaw = function (requestParameters) {
                ...
                switch (_d.label) {
                    case 0:
                        if (requestParameters.startDate === null || requestParameters.startDate === undefined) {
                            throw new runtime.RequiredError('startDate', 'Required parameter requestParameters.startDate was null or undefined when calling aggregateNftPurchaseByCollection.');
                        }
                        if (requestParameters.endDate === null || requestParameters.endDate === undefined) {
                            throw new runtime.RequiredError('endDate', 'Required parameter requestParameters.endDate was null or undefined when calling aggregateNftPurchaseByCollection.');
                        }
                        queryParameters = {};
                        ...
                        return [4 /*yield*/, this.request({
                                path: "/v0.1/order/aggregations/nftPurchaseByCollection",
                                method: 'GET',
     ...
     * Aggregate NFT purchase by collection
     */
    OrderAggregationControllerApi.prototype.aggregateNftPurchaseByCollection = function (requestParameters) {
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.aggregateNftPurchaseByCollectionRaw(requestParameters)];
                    case 1:
                        response = _a.sent();
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        headerParameters = {};
                        return [4 /*yield*/, this.request({
                                path: "/v0.1/order/aggregations/nftPurchaseByTaker",
                                method: 'GET',
                                headers: headerParameters,
                                query: queryParameters,
                            })];
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        headerParameters = {};
                        return [4 /*yield*/, this.request({
                                path: "/v0.1/order/aggregations/nftSellByMaker",
                                method: 'GET',
                                headers: headerParameters,
                                query: queryParameters,
                            })];
