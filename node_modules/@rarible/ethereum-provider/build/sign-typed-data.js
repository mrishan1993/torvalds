    ...
    return (0, tslib_1.__awaiter)(this, void 0, void 0, function () {
        ...
        return (0, tslib_1.__generator)(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    error_1 = _a.sent();
                    console.error("got error white executing sign typed data v4", error_1);
                ...
                case 6:
                    error_2 = _a.sent();
                    console.error("got error white executing sign typed data v3", error_2);
        ...
        return (0, tslib_1.__generator)(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    _a = toBuffer;
                    return [4 /*yield*/, send("eth_sign", [signer, "0x" + hash.toString("hex")])];
                case 1:
