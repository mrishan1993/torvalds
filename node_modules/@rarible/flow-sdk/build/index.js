...
exports.isFlowContractAddress = exports.toFlowContractAddress = exports.isFlowItemId = exports.toFlowItemId = exports.createFlowSdk = exports.createFlowApisSdk = void 0;
var tslib_1 = require("tslib");
var ApiClient = (0, tslib_1.__importStar)(require("@rarible/flow-api-client"));
...
function createFlowApisSdk(env, params) {
    ...
    var configuration = new ApiClient.Configuration((0, tslib_1.__assign)({ basePath: config.flowApiBasePath }, params));
    return {
...
function createFlowSdk(fcl, network, params, auth) {
    ...
    var apis = createFlowApisSdk(blockchainNetwork, (0, tslib_1.__assign)({ basePath: env_1.ENV_CONFIG[network].basePath }, params));
    return {
        apis: apis,
        nft: {
        ...
        order: {
            sell: sell_1.sell.bind(null, fcl, auth, blockchainNetwork),
            fill: fill_1.fill.bind(null, fcl, auth, blockchainNetwork, apis.order).bind(null, apis.item),
            cancelOrder: cancel_order_1.cancelOrder.bind(null, fcl, auth, blockchainNetwork, apis.order),
            updateOrder: update_order_1.updateOrder.bind(null, fcl, apis.item, apis.order, auth).bind(null, blockchainNetwork),
...
var index_2 = require("./common/flow-address/index");
Object.defineProperty(exports, "toFlowContractAddress", { enumerable: true, get: function () { return index_2.toFlowContractAddress; } });
Object.defineProperty(exports, "isFlowContractAddress", { enumerable: true, get: function () { return index_2.isFlowContractAddress; } });
