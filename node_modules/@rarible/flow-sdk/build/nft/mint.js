...
function mint(fcl, auth, network, collection, metadata, royalties) {
    return (0, tslib_1.__awaiter)(this, void 0, void 0, function () {
        var _a, map, address, config, name, txId, txResult, mintEvent;
        return (0, tslib_1.__generator)(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    if (!config.mintable) return [3 /*break*/, 3];
                    return [4 /*yield*/, (0, transaction_1.runTransaction)(fcl, map, (0, nft_1.getNftCode)(name).mint(fcl, address, metadata, royalties), auth)];
                case 1:
                    txId = _b.sent();
