...
function transfer(fcl, auth, network, collection, tokenId, to) {
    return (0, tslib_1.__awaiter)(this, void 0, void 0, function () {
        var _a, map, name_1, checkReceiver, txId;
        return (0, tslib_1.__generator)(this, function (_b) {
            switch (_b.label) {
                case 0:
                    if (!fcl) return [3 /*break*/, 5];
                    _a = (0, get_config_1.getCollectionConfig)(network, collection), map = _a.map, name_1 = _a.name;
                ...
                case 5: throw new Error("Fcl is required for transfer");
            }
        });
    });
}
