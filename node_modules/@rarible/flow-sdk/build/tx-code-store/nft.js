...
var collection_1 = require("../common/collection");
...
function getNftCode(name) {
    if (collection_1.flowCollections.includes(name)) {
            ...
            mint: function (fcl, address, metadata, royalties) {
                if (name === "RaribleNFT") {
                    ...
                    return {
                        ...
                        args: fcl.args([fcl.arg(metadata, t.String), fcl.arg((0, convert_royalties_1.convertRoyalties)(royalties), RoyaltiesType)]),
                    };
                }
