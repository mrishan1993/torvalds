...
declare type SendMethod = (api: GatewayControllerApi, functionCall: EthereumFunctionCall, options?: EthereumSendOptions) => Promise<EthereumTransaction>;
export declare function getSendWithInjects(injects?: {
    logger?: ILoggerConfig;
}): SendMethod;
declare type SimpleSendMethod = (functionCall: EthereumFunctionCall, options?: EthereumSendOptions) => Promise<EthereumTransaction>;
