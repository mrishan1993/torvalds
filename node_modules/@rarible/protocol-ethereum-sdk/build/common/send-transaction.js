...
function getSendWithInjects(injects) {
    ...
    return function send(api, functionCall, options) {
        return (0, tslib_1.__awaiter)(this, void 0, void 0, function () {
            var callInfo, logsAvailable, tx, err_1;
                ...
                switch (_a.label) {
                    ...
                    case 4:
                        ...
                        if (logsAvailable && logger.level >= types_2.LogsLevel.TRACE) {
                            logger.instance.trace(callInfo.method, { from: callInfo.from, args: callInfo.args, tx: tx });
                        }
                        return [2 /*return*/, tx];
                    case 5:
                        err_1 = _a.sent();
                        if (logsAvailable && logger.level >= types_2.LogsLevel.ERROR && callInfo) {
                            logger.instance.error(callInfo.method, { from: callInfo.from, args: callInfo.args, error: err_1.toString() });
                        }
                        throw err_1;
