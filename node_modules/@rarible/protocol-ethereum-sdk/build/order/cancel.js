...
function cancel(checkLazyOrder, ethereum, config, checkWalletChainId, orderToCheck) {
        ...
        return (0, tslib_1.__generator)(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    switch (order.type) {
                        case "RARIBLE_V1":
                            return [2 /*return*/, cancelLegacyOrder(ethereum, config.v1, order)];
                        case "RARIBLE_V2":
                            return [2 /*return*/, cancelV2Order(ethereum, config.v2, order)];
                        case "OPEN_SEA_V1":
                            return [2 /*return*/, cancelOpenseaOrderV1(ethereum, config.openseaV1, order)];
                        case "CRYPTO_PUNK":
                            return [2 /*return*/, cancelCryptoPunksOrder(ethereum, order)];
                        default:
...
function cancelLegacyOrder(ethereum, contract, order) {
    return (0, tslib_1.__awaiter)(this, void 0, void 0, function () {
        var v1;
        return (0, tslib_1.__generator)(this, function (_a) {
            v1 = (0, exchange_v1_1.createExchangeV1Contract)(ethereum, contract);
            return [2 /*return*/, v1.functionCall("cancel", (0, rarible_v1_1.toStructLegacyOrderKey)(order)).send()];
        });
    });
}
function cancelV2Order(ethereum, contract, order) {
    return (0, tslib_1.__awaiter)(this, void 0, void 0, function () {
        var v2;
        return (0, tslib_1.__generator)(this, function (_a) {
            v2 = (0, exchange_v2_1.createExchangeV2Contract)(ethereum, contract);
            return [2 /*return*/, v2.functionCall("cancel", (0, sign_order_1.orderToStruct)(ethereum, order)).send()];
        });
    });
}
function cancelOpenseaOrderV1(ethereum, contract, order) {
    var exchangeContract = (0, exchange_opensea_v1_1.createOpenseaContract)(ethereum, contract);
    var dto = (0, open_sea_converter_1.convertOpenSeaOrderToDTO)(ethereum, order);
    var makerVRS = (0, to_vrs_1.toVrs)(order.signature || "0x");
    return exchangeContract.functionCall("cancelOrder_", (0, open_sea_1.getAtomicMatchArgAddresses)(dto), (0, open_sea_1.getAtomicMatchArgUints)(dto), dto.feeMethod, dto.side, dto.saleKind, dto.howToCall, dto.calldata, dto.replacementPattern, dto.staticExtradata, makerVRS.v, makerVRS.r, makerVRS.s)
        .send();
}
exports.cancelOpenseaOrderV1 = cancelOpenseaOrderV1;
function cancelCryptoPunksOrder(ethereum, order) {
...
function cancelCryptoPunkOrderByAsset(ethereum, methodName, assetType) {
