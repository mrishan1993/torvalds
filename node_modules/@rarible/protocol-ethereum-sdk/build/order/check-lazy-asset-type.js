        ...
        return (0, tslib_1.__generator)(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    return [3 /*break*/, 4];
                case 1: return [4 /*yield*/, itemApi.getNftItemByIdRaw({ itemId: type.contract + ":" + type.tokenId })];
                case 2:
                    itemResponse = _b.sent();
                    if (itemResponse.status === 200 && itemResponse.value.lazySupply === "0") {
                        return [2 /*return*/, type];
                    }
                    return [4 /*yield*/, itemApi.getNftLazyItemByIdRaw({ itemId: type.contract + ":" + type.tokenId })];
                case 3:
