...
exports.erc20TransferProxyBytecode = exports.deployErc20TransferProxy = exports.createErc20TransferProxyContract = void 0;
var tslib_1 = require("tslib");
function createErc20TransferProxyContract(web3, address) {
    return new web3.eth.Contract(erc20TransferProxyAbi, address);
}
exports.createErc20TransferProxyContract = createErc20TransferProxyContract;
function deployErc20TransferProxy(web3) {
    return (0, tslib_1.__awaiter)(this, void 0, void 0, function () {
        var empty, address;
        return (0, tslib_1.__generator)(this, function (_a) {
            switch (_a.label) {
                case 0:
                    empty = createErc20TransferProxyContract(web3);
                    return [4 /*yield*/, web3.eth.getAccounts()];
                case 1:
                    address = (_a.sent())[0];
                    return [2 /*return*/, empty.deploy({ data: exports.erc20TransferProxyBytecode }).send({ from: address, gas: 4000000, gasPrice: "0" })];
            }
        });
    });
}
exports.deployErc20TransferProxy = deployErc20TransferProxy;
var erc20TransferProxyAbi = [
    {
        anonymous: false,
        inputs: [
            {
