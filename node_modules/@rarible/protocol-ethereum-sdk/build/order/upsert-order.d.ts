...
export declare class UpsertOrder {
    ...
    constructor(orderFiller: OrderFiller, checkLazyOrder: (form: CheckLazyOrderPart) => Promise<CheckLazyOrderPart>, approveFn: ApproveFunction, signOrder: (order: SimpleOrder) => Promise<Binary>, orderApi: OrderControllerApi, ethereum: Maybe<Ethereum>, checkWalletChainId: () => Promise<boolean>);
