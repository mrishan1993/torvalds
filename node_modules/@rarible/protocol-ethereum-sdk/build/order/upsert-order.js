...
var UpsertOrder = /** @class */ (function () {
    function UpsertOrder(orderFiller, checkLazyOrder, approveFn, signOrder, orderApi, ethereum, checkWalletChainId) {
        var _this = this;
        ...
        return (0, tslib_1.__awaiter)(this, void 0, void 0, function () {
            ...
            return (0, tslib_1.__generator)(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 3: return [4 /*yield*/, (0, erc20_1.createErc20Contract)(this.ethereum, assetType.contract)
                            .functionCall("decimals")
                            .call()];
                    case 4:
                        decimals = _b.sent();
                        return [2 /*return*/, (0, bn_1.toBn)(hasPrice.priceDecimal).multipliedBy((0, bn_1.toBn)(10).pow(Number(decimals)))];
                    case 5: throw new Error("Asset type should be either ETH or ERC-20, received=" + JSON.stringify(assetType));
                }
            });
        });
    };
            ...
            return (0, tslib_1.__generator)(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.updateCryptoPunkOrderByContract(this.ethereum, order, request)];
                    case 2:
                        _a.sent();
            ...
            return (0, tslib_1.__generator)(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, ethContract.functionCall("offerPunkForSale", order.make.assetType.tokenId, price).send()];
                    case 2:
                        _a.sent();
                        return [3 /*break*/, 6];
                    case 3:
                        ...
                        return [4 /*yield*/, ethContract.functionCall("enterBidForPunk", order.take.assetType.tokenId).send({ value: price.toString() })];
                    case 4:
                        _a.sent();
                        return [3 /*break*/, 6];
