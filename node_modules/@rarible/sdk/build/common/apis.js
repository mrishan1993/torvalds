...
var ApiClient = (0, tslib_1.__importStar)(require("@rarible/api-client"));
var config_1 = require("../config");
function createApisSdk(env, params) {
    if (params === void 0) { params = {}; }
    var config = (0, config_1.getSdkConfig)(env);
    var configuration = new ApiClient.Configuration((0, tslib_1.__assign)({ basePath: config.basePath }, params));
    return {
