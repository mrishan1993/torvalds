...
export declare type IRaribleInternalSdk = Omit<IRaribleSdk, "order" | "nft" | "apis"> & {
    nft: INftInternalSdk;
    order: IOrderInternalSdk;
    balances: IBalanceSdk;
};
export declare type INftInternalSdk = Omit<INftSdk, "mintAndSell"> & {
    generateTokenId: IGenerateTokenId;
};
export declare type IOrderInternalSdk = Omit<IOrderSdk, "sell"> & {
    sell: ISellInternal;
};
