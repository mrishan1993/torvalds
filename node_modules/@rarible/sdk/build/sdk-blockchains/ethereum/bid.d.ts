...
export declare class EthereumBid {
    ...
    constructor(sdk: RaribleSdk, wallet: Maybe<EthereumWallet>, balanceService: EthereumBalance, network: EthereumNetwork);
    ...
    getConvertableValueCommon(assetType: AssetType, price: BigNumberValue, amount: number, originFeesSum: number): Promise<GetConvertableValueResult>;
