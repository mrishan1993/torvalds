...
function toEthereumParts(parts) {
    return (parts === null || parts === void 0 ? void 0 : parts.map(function (fee) { return ({
...
function isEVMBlockchain(blockchain) {
    for (var _i = 0, EVMBlockchains_1 = exports.EVMBlockchains; _i < EVMBlockchains_1.length; _i++) {
        var b = EVMBlockchains_1[_i];
        if (b === blockchain) {
            return true;
        }
    }
...
function convertToEthereumAddress(contractAddress) {
    ...
    var _a = contractAddress.split(":"), blockchain = _a[0], address = _a[1];
...
function convertEthereumContractAddress(address, blockchain) {
    return (0, types_1.toContractAddress)(blockchain + ":" + address);
}
