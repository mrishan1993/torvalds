...
import type { CommonFillRequestAssetType, FillOrderRequest } from "@rarible/protocol-ethereum-sdk/build/order/fill-order/types";
...
export declare class EthereumFill {
    ...
    getPreparedOrder(request: PrepareFillRequest): Promise<SimplePreparedOrder>;
