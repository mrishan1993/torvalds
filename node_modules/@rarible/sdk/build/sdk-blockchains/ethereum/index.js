...
function createEthereumSdk(wallet, apis, network, params, logs) {
    var sdk = (0, protocol_ethereum_sdk_1.createRaribleSdk)(wallet === null || wallet === void 0 ? void 0 : wallet.ethereum, network, { apiClientParams: params, logs: logs });
    var sellService = new sell_1.EthereumSell(sdk, network);
    var balanceService = new balance_1.EthereumBalance(sdk);
    var bidService = new bid_1.EthereumBid(sdk, wallet, balanceService, network);
    var mintService = new mint_1.EthereumMint(sdk, apis, network);
    var fillerService = new fill_1.EthereumFill(sdk, wallet, network);
    return {
        nft: {
            ...
            deploy: new deploy_1.EthereumDeploy(sdk, network).deployToken,
