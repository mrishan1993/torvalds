...
var EthereumSdk = (0, tslib_1.__importStar)(require("@rarible/protocol-ethereum-sdk"));
...
var mint_request_type_validator_1 = require("../../types/nft/mint/mint-request.type.validator");
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, {
                                ...
                                submit: action_1.Action.create({
                                    id: "mint",
                                    run: function (data) { return (0, tslib_1.__awaiter)(_this, void 0, void 0, function () {
                                        var validated, mintResponse;
                                        return (0, tslib_1.__generator)(this, function (_a) {
                                            switch (_a.label) {
                                                case 0:
                                                    validated = (0, mint_request_type_validator_1.validateMintRequest)(data);
                                                    return [4 /*yield*/, this.handleSubmit(validated, nftCollection, toNftTokenId(request.tokenId))];
                                                case 1:
...
function toNftCollection(collection) {
    ...
    return (0, tslib_1.__assign)((0, tslib_1.__assign)({}, collection), { id: (0, types_1.toAddress)(contract), type: ethereum_api_client_1.NftCollectionType[collection.type], owner: collection.owner ? (0, common_1.convertToEthereumAddress)(collection.owner) : undefined, features: (_a = collection.features) === null || _a === void 0 ? void 0 : _a.map(function (x) { return ethereum_api_client_1.NftCollectionFeatures[x]; }) });
}
