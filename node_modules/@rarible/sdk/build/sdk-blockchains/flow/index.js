...
function createFlowSdk(wallet, apis, network, params, auth) {
    ...
    return {
        ...
        order: {
            ...
            acceptBid: not_implemented_1.nonImplementedAction,
            bid: not_implemented_1.nonImplementedAction,
            bidUpdate: not_implemented_1.nonImplementedAction,
            cancel: new cancel_1.FlowCancel(sdk, apis, blockchainNetwork).cancel,
        },
        balances: {
            getBalance: new balance_1.FlowBalance(sdk).getBalance,
        },
        restriction: {
