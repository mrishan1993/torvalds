...
var TezosBid = /** @class */ (function () {
    ...
    TezosBid.prototype.getConvertMap = function () {
        var _a;
        return _a = {},
            _a[(0, common_1.convertTezosToUnionAddress)(this.provider.config.wrapper)] = "XTZ",
            _a;
    };
    ...
    TezosBid.prototype.getWXTZContractAddress = function () {
        ...
        var wXTZUnionContract = wXTZAddressEntry[0];
                ...
                switch (_b.label) {
                    ...
                    case 2:
                        ...
                        submit = action_1.Action.create({
                                ...
                                return (0, tslib_1.__generator)(this, function (_b) {
                                    switch (_b.label) {
                                        case 0:
                                            ...
                                            if (!(request.currency["@type"] === "TEZOS_FT" && request.currency.contract === wXTZUnionAddress)) return [3 /*break*/, 3];
                            ...
                            id: "send-tx",
                            run: function (request) { return (0, tslib_1.__awaiter)(_this, void 0, void 0, function () {
                                var provider, makerPublicKey, order, _a, _b;
                                var _c;
                                return (0, tslib_1.__generator)(this, function (_d) {
                                    switch (_d.label) {
                                        case 0:
                                ...
                                return (0, tslib_1.__generator)(this, function (_b) {
                                    switch (_b.label) {
                                        case 0:
                                            ...
                                            if (!(order.make.assetType.assetClass === "FT" && order.make.assetType.contract === wXTZUnionAddress)) return [3 /*break*/, 3];
                                    ...
                                    switch (_c.label) {
                                        case 0:
                                            ...
                                            orderForm = {
                                                ...
                                                make: (0, tslib_1.__assign)((0, tslib_1.__assign)({}, (0, common_1.covertToLibAsset)(order.make)), { value: new bignumber_js_1.default(updateRequest.price).multipliedBy(order.take.value) }),
