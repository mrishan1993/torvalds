...
var TezosBurn = /** @class */ (function () {
    function TezosBurn(provider, apis, network) {
                                ...
                                submit: action_1.Action.create({
                                    ...
                                    run: function (request) { return (0, tslib_1.__awaiter)(_this, void 0, void 0, function () {
                                        ...
                                        return (0, tslib_1.__generator)(this, function (_b) {
                                            switch (_b.label) {
                                                case 0:
                                                    amount = collection.type === "MT" ? new bignumber_js_1.default(((_a = request === null || request === void 0 ? void 0 : request.amount) !== null && _a !== void 0 ? _a : 1).toFixed()) : undefined;
