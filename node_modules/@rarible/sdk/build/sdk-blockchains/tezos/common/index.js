...
function getTezosOrderId(orderId) {
    ...
    var _a = orderId.split(":"), blockchain = _a[0], id = _a[1];
...
function getTezosItemData(itemId) {
    var _a = itemId.split(":"), domain = _a[0], contract = _a[1], tokenId = _a[2];
...
function getTezosAddress(address) {
    var _a = address.split(":"), blockchain = _a[0], tezosAddress = _a[1];
    if (blockchain !== api_client_1.Blockchain.TEZOS) {
...
function getMakerPublicKey(provider) {
    return (0, tslib_1.__awaiter)(this, void 0, void 0, function () {
        ...
        return (0, tslib_1.__generator)(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (0, base_1.get_public_key)(provider)];
                case 1:
                    maker = _a.sent();
                    if (!maker) {
...
function convertOrderToFillOrder(order) {
    return (0, tslib_1.__assign)((0, tslib_1.__assign)({}, convertOrderToOrderForm(order)), { makeStock: (0, big_number_1.toBigNumber)(order.makeStock) });
}
...
function convertFromContractAddress(contract) {
    var _a = contract.split(":"), blockchain = _a[0], tezosAddress = _a[1];
    if (blockchain !== api_client_1.Blockchain.TEZOS) {
...
function convertTezosToContractAddress(address) {
    return (0, types_1.toContractAddress)(api_client_1.Blockchain.TEZOS + ":" + address);
}
