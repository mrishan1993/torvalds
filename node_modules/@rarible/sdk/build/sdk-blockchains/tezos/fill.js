...
var TezosFill = /** @class */ (function () {
    ...
    TezosFill.prototype.getMaxAmount = function (order) {
        return (0, tslib_1.__awaiter)(this, void 0, void 0, function () {
            var provider, _a, contract, token_id, ownershipId, _b, response;
            return (0, tslib_1.__generator)(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        _b = contract + ":" + token_id.toString() + ":";
                        return [4 /*yield*/, (0, tezos_sdk_1.get_address)(provider)];
                    case 1:
                        ownershipId = _b + (_c.sent());
                ...
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        submit = action_1.Action.create({
                            id: "send-tx",
                            run: function (fillRequest) { return (0, tslib_1.__awaiter)(_this, void 0, void 0, function () {
                                ...
                                return (0, tslib_1.__generator)(this, function (_a) {
                                    switch (_a.label) {
                                        case 0:
                                            ...
                                            return [4 /*yield*/, (0, tezos_sdk_1.fill_order)(provider, preparedOrder, request)];
                                        case 1:
