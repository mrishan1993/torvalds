...
var TezosMint = /** @class */ (function () {
    ...
    TezosMint.prototype.getFormatsMeta = function (meta) {
        return [meta.image, meta.animation]
            ...
            if (item) {
                var url = item.url, rest = (0, tslib_1.__rest)(item, ["url"]);
                return acc.concat((0, tslib_1.__assign)((0, tslib_1.__assign)({}, rest), { uri: fixIpfs(url) }));
            }
            return acc;
        }, []);
    };
                                            ...
                                            switch (_d.label) {
                                                case 0:
                                                    ...
                                                    _b = [provider,
                                                        ...
                                                        royalties,
                                                        supply,
                                                        prepareRequest.tokenId ? (0, bn_1.toBn)(prepareRequest.tokenId.tokenId) : undefined,
                                                        {
                                                            "": fixIpfs(request.uri),
                                                        }];
        ...
        return (0, tslib_1.__generator)(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    _a = contractAddress.split(":"), blockchain = _a[0], contract = _a[1];
