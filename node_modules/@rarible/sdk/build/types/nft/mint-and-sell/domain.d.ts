...
export declare type MintAndSellRequest = MintRequest & {
    /**
     * Price per one NFT
     */
...
export declare type MintAndSellResponse = MintResponse & {
    orderId: OrderId;
};
export declare type PrepareMintAndSellResponse = AbstractPrepareResponse<"mint" | "convert" | "approve" | "sign" | "send-tx", MintAndSellRequest, MintAndSellResponse> & {
...
export declare type IMintAndSell = (request: PrepareMintRequest) => Promise<PrepareMintAndSellResponse>;
