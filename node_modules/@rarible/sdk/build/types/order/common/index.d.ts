...
export declare type PrepareOrderInternalRequest = {
    /**
...
declare type BasePrepareOrderResponse<T> = AbstractPrepareResponse<"convert" | "approve" | "sign" | "send-tx", T, OrderId> & {
    /**
     * is multiple nft
     */
    multiple: boolean;
...
export declare type PrepareOrderInternalResponse = BasePrepareOrderResponse<OrderInternalRequest>;
/**
