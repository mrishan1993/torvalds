...
export declare type PrepareFillRequest = {
    /**
...
export declare enum OriginFeeSupport {
    NONE = "NONE",
    AMOUNT_ONLY = "AMOUNT_ONLY",
    FULL = "FULL"
}
export declare enum PayoutsSupport {
    NONE = "NONE",
    SINGLE = "SINGLE",
    MULTIPLE = "MULTIPLE"
}
...
export declare type FillActionTypes = "approve" | "send-tx";
export interface PrepareFillResponse extends AbstractPrepareResponse<FillActionTypes, FillRequest, IBlockchainTransaction> {
    /**
   * is multiple nft
   */
    multiple: boolean;
...
export declare type IFill = (request: PrepareFillRequest) => Promise<PrepareFillResponse>;
