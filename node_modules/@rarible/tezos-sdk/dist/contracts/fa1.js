...
function fa1_storage(owner, supply, decimals, name, symbol, uri) {
    ...
    var metadata = [
        { "prim": "Elt", "args": [{ "string": "decimals" }, { "bytes": (0, base_1.to_hex)(decimals.toString()) }] }
    ];
    if (name != undefined) {
        metadata = metadata.concat({ "prim": "Elt", "args": [{ "string": "name" }, { "bytes": (0, base_1.to_hex)(name) }] });
    }
    if (symbol != undefined) {
        metadata = metadata.concat({ "prim": "Elt", "args": [{ "string": "symbol" }, { "bytes": (0, base_1.to_hex)(symbol) }] });
    }
    if (uri != undefined) {
        metadata = metadata.concat({ "prim": "Elt", "args": [{ "string": "" }, { "bytes": (0, base_1.to_hex)(uri) }] });
    }
    var st = {
        "prim": "Pair", "args": [
            { "int": sup },
