...
function mint_param(token_id, owner, metadata, royalties, amount) {
    var meta = Object.keys(metadata).map(function (k) { return { prim: 'Elt', args: [{ string: k }, { bytes: (0, base_1.to_hex)(metadata[k]) }] }; });
...
function metadata_param(token_id, metadata) {
    return [
        ...
        Object.keys(metadata).sort().map(function (k) { return { prim: 'Elt', args: [{ string: k }, { bytes: (0, base_1.to_hex)(metadata[k]) }] }; })
    ];
}
...
function set_token_metadata(provider, contract, token_id, metadata) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, (0, base_1.send)(provider, metadata_arg(contract, token_id, metadata))];
        });
    });
}
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    ...
                    _a = owner;
                    return [3 /*break*/, 3];
                case 1: return [4 /*yield*/, (0, base_1.get_address)(provider)];
                case 2:
                    _a = _c.sent();
                    _c.label = 3;
                case 3:
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, (0, base_1.send)(provider, arg)];
                case 2:
                    op = _b.sent();
