...
exports.approve = exports.approve_arg = exports.approve_fa2 = exports.approve_fa2_arg = exports.approve_fa1_2 = exports.approve_fa1_2_arg = void 0;
...
function key_expr(value, type) {
    ...
    var hash = blake.blake2b((0, base_1.hex_to_uint8array)(b), null, 32);
    return (0, base_1.b58enc)(hash, new Uint8Array([13, 44, 64, 27]));
}
...
function approve_fa1_2_arg(provider, owner, contract, value, infinite) {
    if (infinite === void 0) { infinite = true; }
    return __awaiter(this, void 0, void 0, function () {
        var spender, st, key_exists, balance, r, _a, v, parameter;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    spender = provider.config.transfer_proxy;
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    if (arg) {
                        try {
                            return [2 /*return*/, (0, base_1.send)(provider, arg)];
                        }
                        catch (e) {
                            return [2 /*return*/, undefined];
                        }
...
function approve_fa2_arg(provider, owner, contract, token_id, use_all) {
    if (use_all === void 0) { use_all = false; }
    return __awaiter(this, void 0, void 0, function () {
        var operator, st, key_exists, r, _a, parameter, r, id, value, type, r, _b, parameter;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    operator = provider.config.transfer_proxy;
                    return [4 /*yield*/, provider.tezos.storage(contract)];
                case 1:
                    st = _c.sent();
                    key_exists = false;
...
function approve_arg(provider, owner, asset, use_all, infinite) {
    if (use_all === void 0) { use_all = false; }
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            if (asset.asset_type.asset_class == "FT" && asset.asset_type.token_id == undefined) {
                return [2 /*return*/, approve_fa1_2_arg(provider, owner, asset.asset_type.contract, asset.value, infinite)];
            }
            else if (asset.asset_type.asset_class == "FT" && asset.asset_type.token_id != undefined) {
                return [2 /*return*/, approve_fa2_arg(provider, owner, asset.asset_type.contract, asset.asset_type.token_id)];
            }
            else if (asset.asset_type.asset_class == "NFT") {
                return [2 /*return*/, approve_fa2_arg(provider, owner, asset.asset_type.contract || provider.config.nft_public, asset.asset_type.token_id, use_all)];
            }
            else if (asset.asset_type.asset_class == "MT") {
                return [2 /*return*/, approve_fa2_arg(provider, owner, asset.asset_type.contract || provider.config.mt_public, asset.asset_type.token_id, use_all)];
            }
            else
