...
function fill_order(provider, left, request) {
    return __awaiter(this, void 0, void 0, function () {
        var pk, _a, make, up, right, arg_approve, _b, _c, _d, args, amount, _e, _f, parameter, _g, _h, right_salt, signature, mp, r_add, _j, _k, r_match, _l, _m, json, hash;
        var _this = this;
        return __generator(this, function (_o) {
            switch (_o.label) {
                case 0:
                    ...
                    _a = request.edpk;
                    return [3 /*break*/, 3];
                case 1: return [4 /*yield*/, (0, base_1.get_public_key)(provider)];
                case 2:
                    _a = _o.sent();
                    _o.label = 3;
                case 3:
                ...
                case 6:
                    right = _o.sent();
                    if (!(up == undefined)) return [3 /*break*/, 20];
                    if (!(make.asset_type.asset_class != "XTZ")) return [3 /*break*/, 9];
                    _c = approve_1.approve_arg;
                    _d = [provider];
                    return [4 /*yield*/, (0, base_1.get_address)(provider)];
                case 7: return [4 /*yield*/, _c.apply(void 0, _d.concat([_o.sent(), make, request.use_all, request.infinite]))];
                case 8:
                    _b = _o.sent();
                    return [3 /*break*/, 10];
                case 9:
                ...
                case 17:
                    ...
                    if (!(left.make.asset_type.asset_class == "FT" && left.make.asset_type.contract == provider.config.wrapper && left.make.asset_type.token_id != undefined && left.make.asset_type.token_id.isZero())) return [3 /*break*/, 19];
                    _h = (_g = args).concat;
                    return [4 /*yield*/, (0, wrapper_1.unwrap_arg)(provider, left.make.value)];
                case 18:
                    args = _h.apply(_g, [_o.sent()]);
                    _o.label = 19;
                case 19: return [2 /*return*/, (0, base_1.send_batch)(provider, args)];
                case 20:
                ...
                case 23:
                    r_add = _o.sent();
                    if (!!r_add.ok) return [3 /*break*/, 25];
                    _j = Error.bind;
                    _k = r_add.statusText + ' ';
                    return [4 /*yield*/, r_add.text()];
                case 24: throw new (_j.apply(Error, [void 0, _k + (_o.sent())]))();
                case 25:
                    console.log(JSON.stringify({
                        left: (0, utils_1.order_to_json)(left), right: (0, utils_1.order_to_json)(right)
                    }));
                    return [4 /*yield*/, (0, node_fetch_1.default)(provider.config.api_permit + '/permit/match_orders', {
                            method: 'POST', headers: [['content-type', 'application/json']],
                            body: JSON.stringify({
                                left: (0, utils_1.order_to_json)(left), right: (0, utils_1.order_to_json)(right)
                            })
                ...
                case 26:
                    r_match = _o.sent();
                    if (!!r_match.ok) return [3 /*break*/, 28];
                    _l = Error.bind;
                    _m = r_match.statusText + ' ';
                    return [4 /*yield*/, r_match.text()];
                case 27: throw new (_l.apply(Error, [void 0, _m + (_o.sent())]))();
                case 28: return [4 /*yield*/, r_match.json()];
                case 29:
                    json = _o.sent();
