...
function invert_order(order, amount, maker_edpk, salt) {
    ...
    return __assign(__assign({}, order), { make: __assign(__assign({}, order.take), { value: makeValue }), take: __assign(__assign({}, order.make), { value: takeValue }), maker: (0, base_1.pk_to_pkh)(maker_edpk), maker_edpk: maker_edpk, taker: order.maker, taker_edpk: order.maker_edpk, salt: salt, signature: undefined });
}
