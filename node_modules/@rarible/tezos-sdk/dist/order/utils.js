...
function order_to_json(order) {
    ...
    return __assign({ make: (0, base_1.asset_to_json)(order.make), take: (0, base_1.asset_to_json)(order.take), data: data_to_json(data), makerEdpk: maker_edpk, takerEdpk: taker_edpk }, rest);
}
...
function order_of_json(order) {
    ...
    return __assign({ make: (0, base_1.asset_of_json)(order.make), take: (0, base_1.asset_of_json)(order.take), data: data_of_json(data), maker_edpk: makerEdpk, taker_edpk: takerEdpk }, rest);
}
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3: throw new Error("cannot get royalties for " + id);
            }
        });
    });
}
