...
var BeaconWallet = /** @class */ (function () {
    ...
    BeaconWallet.prototype.mapTransferParamsToWalletParams = function (params) {
        return __awaiter(this, void 0, void 0, function () {
            var walletParams, err_1, _a, _b;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0: return [4 /*yield*/, this.client.showPrepare()];
                    case 1:
                        _c.sent();
                        _c.label = 2;
                    case 2:
                    ...
                    case 6:
                        ...
                        _b = [walletParams];
                        return [4 /*yield*/, createTransferOperation(this.formatParameters(walletParams))];
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 6:
                        _a = this.removeDefaultParams;
                        _b = [walletParams];
                        return [4 /*yield*/, createOriginationOperation(this.formatParameters(walletParams))];
                    case 7: return [2 /*return*/, _a.apply(this, _b.concat([_c.sent()]))];
                }
            });
        });
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 6:
                        _a = this.removeDefaultParams;
                        _b = [walletParams];
                        return [4 /*yield*/, createSetDelegateOperation(this.formatParameters(walletParams))];
                    case 7: return [2 /*return*/, _a.apply(this, _b.concat([_c.sent()]))];
                }
            });
        });
...
//# sourceMappingURL=taquito-beacon-wallet.es5.js.map
